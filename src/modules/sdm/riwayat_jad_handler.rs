// src/modules/sdm/riwayat_jad_handler.rs
use super::{
    karir_dosen_model::{RiwayatJad, RiwayatJadPayload},
    riwayat_jad_repo as repo,
};
...
pub async fn create_handler(
    ...
    Json(payload): Json<RiwayatJadPayload>,
) -> Result<(StatusCode, Json<RiwayatJad>), AppError> {
...
pub async fn get_all_by_pegawai_id_handler(
    State(pool): State<DbPool>,
    Path(pegawai_id): Path<Uuid>,
) -> Result<Json<Vec<RiwayatJad>>, AppError> {
...
pub async fn update_handler(
    ...
    Path(id): Path<Uuid>,
    Json(payload): Json<RiwayatJadPayload>,
) -> Result<Json<RiwayatJad>, AppError> {
